            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Cadastros <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo $this->Html->url(array('plugin'=>null, 'controller'=>'alunos', 'action'=>'add'));?>">Cadastro Alunos</a></li>
                                <li><a href="<?php echo $this->Html->url(array('plugin'=>null, 'controller'=>'disciplinas', 'action'=>'add'));?>"<>Cadastro Disciplinas</a></li>
                                <li><a href="404.html">Cadastro Turmas</a></li>
                                <li><a href="shortcodes.html">Cadastro Disciplinas</a></li>
                            </ul>
                      ...
                      <li class="dropdown">
                        ...
                        <li><a href="<?php echo $this->Html->url(array('plugin'=>'admin', 'controller'=>'users', 'action'=>'index'));?>">Professores</a></li>
</a></li>
