<div class="alunos index">
	...
	<div class="row">
			...
			<?php echo $this->Html->link($aluno['Documento']['name'], array('controller' => 'documentos', 'action' => 'view', $aluno['Documento']['id'])); ?>
						...
						<td>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $aluno['Aluno']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $aluno['Aluno']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $aluno['Aluno']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $aluno['Aluno']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
