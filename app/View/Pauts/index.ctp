<div class="pauts index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Pauts'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Paut'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('anos_id'); ?></th>
						<th class="actions"></th>
					</tr>
				</thead>
				<tbody>
				<?php foreach ($pauts as $paut): ?>
					<tr>
						<td><?php echo h($paut['Paut']['id']); ?>&nbsp;</td>
								<td>
			...
			<?php echo $this->Html->link($paut['Anos']['name'], array('controller' => 'anos', 'action' => 'view', $paut['Anos']['id'])); ?>
						...
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $paut['Paut']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $paut['Paut']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $paut['Paut']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $paut['Paut']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
