<div class="users form">
	...
	<div class="row">
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('User', array('role' => 'form')); ?><br><br><br>

				<div class="form-group">
					<?php echo $this->Form->hidden('name', array('class' => 'form-control', 'default' =>$_SESSION["nomealuno"]));?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->hidden('username', array('class' => 'form-control', 'default' => $_SESSION["alunouser"]));?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->input('password', array('class' => 'form-control', 'placeholder' => 'Password'));?>
				</div>
               		<div class="form-group">
					<?php echo $this->Form->input('confirm_password', array('type'=>'password','class' => 'form-control', 'placeholder' => 'Password'));?>
				</div>
				<div class="form-group">
					<?php echo $this->Form->hidden('group_id', array('class' => 'form-control', 'default' => 5));?>
				</div>
				<div class="form-group">
