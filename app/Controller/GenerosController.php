	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Genero->save($this->request->data)) {
				...
				$this->Session->setFlash(__('The genero could not be saved. Please, try again.'), 'default', array('class' => 'alert alert-danger'));
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Genero->delete()) {
			...
			$this->Session->setFlash(__('The genero could not be deleted. Please, try again.'), 'default', array('class' => 'alert alert-danger'));
		}
		return $this->redirect(array('action' => 'index'));
	}
}
